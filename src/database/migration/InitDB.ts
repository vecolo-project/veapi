...
export class InitDB1621280558787 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'CREATE TABLE `bike_model` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, `batteryCapacity` double NOT NULL, `weight` double NOT NULL, `maxPower` double NOT NULL, `maxSpeed` double NOT NULL, `maxDistance` double NOT NULL, `description` text NOT NULL, `image` varchar(255) NOT NULL, `icon` varchar(255) NOT NULL, `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `bikeManufacturerId` int NULL, UNIQUE INDEX `IDX_279c2b880bd73eb3e4378de14c` (`name`), PRIMARY KEY (`id`)) ENGINE=InnoDB'
    );
    await queryRunner.query(
