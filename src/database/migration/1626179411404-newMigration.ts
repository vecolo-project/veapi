...
export class newMigration1626179411404 implements MigrationInterface {
    name = 'newMigration1626179411404'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `ride` CHANGE `invoiceAmount` `invoiceAmount` decimal(15,2) NOT NULL DEFAULT 0");
    }
