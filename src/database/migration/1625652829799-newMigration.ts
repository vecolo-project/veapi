...
export class newMigration1625652829799 implements MigrationInterface {
    name = 'newMigration1625652829799'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE FULLTEXT INDEX `IDX_58e4dbff0e1a32a9bdc861bb29` ON `user` (`firstName`)");
        await queryRunner.query("CREATE FULLTEXT INDEX `IDX_f0e1b4ecdca13b177e2e3a0613` ON `user` (`lastName`)");
        await queryRunner.query("CREATE FULLTEXT INDEX `IDX_be726a825c7254f55be1540601` ON `user` (`pseudo`)");
