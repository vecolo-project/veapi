...
export class newMigration1625659972869 implements MigrationInterface {
    name = 'newMigration1625659972869'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `user` ADD FULLTEXT email_fulltext(`email`);");
    }
